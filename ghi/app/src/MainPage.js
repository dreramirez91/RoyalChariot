...
function MainPage() {
  return (
    <div className='main'>
      ...
      <footer><hr style={{ color: "white" }} />© Copyright CarCar Motors 2023. Registered Office: Miracle Lane, Aspen, Colorado, United States of America. Registered in USA: Number 843912</footer>
    </div>
